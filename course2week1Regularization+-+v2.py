...
def forward_propagation_with_dropout(X, parameters, keep_prob = 0.5):
    ...
    D1 = np.random.rand(20,X.shape[1])                           # Step 1: initialize matrix D1 = np.random.rand(..., ...)
    ...
    D2 = np.random.rand(3,X.shape[1])                                # Step 1: initialize matrix D2 = np.random.rand(..., ...)
...
def backward_propagation_with_dropout(X, Y, cache, keep_prob):
    ...
    dA2 = dA2/keep_prob              # Step 1: Apply mask D2 to shut down the same neurons as during the forward propagation
    ...
    dA1 = np.dot(W2.T, dZ2)
    ### START CODE HERE ### (≈ 2 lines of code)
    dA1 =  D1*dA1            # Step 1: Apply mask D2 to shut down the same neurons as during the forward propagation
